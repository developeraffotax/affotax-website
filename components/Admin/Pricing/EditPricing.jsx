...
export default function EditPricingComponent() {
	...
	return (
		<>
			<section className="text-gray-700 body-font w-full py-4 overflow-hidden border-t border-b-2  border-gray-200 px-20 max-xl:px-0 ">
        ...
        <input className="border-none ring-2 ring-gray-300 rounded-lg p-2 w-full shadow-sm hover:ring-gray-500  outline-none focus:ring-blue-500   transition duration-300  " value={service} onChange={modalServiceInputHandler} />
                ...
                <button  className="px-8 py-2 rounded-md bg-teal-500 text-white font-bold transition duration-200 hover:bg-white hover:text-teal-500 border-2 border-transparent hover:border-teal-500">Update Pricing Section</button>
			</section>
		</>
	);
}
