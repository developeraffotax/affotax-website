...
const contactArr = [{name: 'Phone', icon: <LuPhoneCall className='scale-125 mr-3'/> , link:'tel:02081294481',  value: '020 8129 4481', timings: '07:00 - 20:00 | Monday to Friday' }, {name: 'Email', icon: <MdOutlineMailOutline className=' scale-125 mr-2'/> ,link: 'mailto:info@affotax.com', value: 'info@affotax.com', timings: '07:00 - 20:00 | Monday to Friday' }, {name: 'Whatsapp', icon: <FaWhatsapp  className='text-green-500 scale-125 mr-2'/> ,link: 'https://wa.me/447537188920', value: 'Whatsapp Us', timings: '07:00 - 20:00 | Monday to Friday' }]
