...
const reviewArr = [
    {
        ...
        content: 'Very professional and expert team. I am very satisfied with the exceptional service provided by Affotax. Would definitely purchase your services in the future. '
    },

    {
        ...
        content: 'Working with Affotax was the best experience. Their expertise speaks loudly throughout the entire process. They understood my requirements and provided me exactly what I wanted. '
    },

    {
        ...
        content: 'The best accountancy firm in the UK. Very professional and quick team. They worked till I was satisfied and informed me at every stage of the process. They involved me and I felt confident in the decisions being made. 100% recommended! '
    },

    {
        ...
        content: 'I was recommended to Affotax by a colleague, and it turned out to be one of the best decisions for my business. Affotax has become an integral part of my business journey, providing the services and expertise that every entrepreneur needs. I wholeheartedly endorse their services. '
    },

    {
        ...
        content: 'I have had the pleasure of working with Affotax for the past three years, and I am continually impressed by their expertise and attention to details. I am confident in recommending their services to fellow entrepreneurs.  '
    },
                    ...
                    <div className="box flex flex-col gap-y-4 w-full ">
                        <div className="flex items-center w-full">
                            ...
                            <p className="h-2 w-full sm:min-w-[278px] rounded-3xl bg-amber-50 ml-5 mr-3">
                                <span className="h-full w-[80%] rounded-3xl bg-amber-400 flex"></span>
                            </p>
