...
const Form = () => {
  ...
  return (
    <div className='flex flex-row max-lg:flex-col justify-center w-full  gap-4 py-8'>
         
        <div className=' bg-white w-[80%] max-lg:w-full p-4 drop-shadow-xl rounded-2xl '>
            <form ref={formRef} action={formActionHandler}  className='flex flex-col  items-start gap-4'>
                <h2 className='w-full text-center font-semibold text-lg '>Get In Touch</h2>
                ...
                <textarea className='px-2 py-1 bg-white rounded-lg w-full border-2 border-black/40 shadow-md shadow-black/10 outline-none focus:border-primary focus:shadow-primary/30'  name="message" placeholder='Write your message*'></textarea>
