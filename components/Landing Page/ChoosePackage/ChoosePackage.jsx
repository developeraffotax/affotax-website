...
export default function ChoosePackage({pricingPage, pricing}) {
    ...
    <section className="text-gray-700 body-font w-full py-4 overflow-hidden border-t border-b-2 font-Outfit  border-gray-200 px-96 max-[1800px]:px-60 max- max-2xl:px-40 max-xl:px-8 ">
        ...
        <div className="w-full flex justify-center ">
            ...
            <div className="flex w-full flex-wrap lg:border border-gray-300 rounded-none  ">
               ...
               <PricingTemplate {...first} finalArr={finalArr} onClick={onClickLocalStorageHandler.bind(null, parsedPricing?.prices[0]?._id)}/>
                ...
                <PricingTemplate {...second} finalArr={finalArr} onClick={onClickLocalStorageHandler.bind(null,  parsedPricing?.prices[1]?._id)}/>
                ...
                <PricingTemplate {...third} finalArr={finalArr} onClick={onClickLocalStorageHandler.bind(null,  parsedPricing?.prices[2]?._id)}/>
...
<div className="container  py-12 mx-auto">
   ...
   <p className='text-base text-orange-400 font-semibold mb-2'>Pricing & Plan</p>
       <h2 className="sm:text-3xl text-2xl font-medium title-font text-gray-900  mb-2">
           {title}
       </h2>
       <p className='text-sm'>Making tax filing affordable with 100% satisfaction and 30-day Money-Back guarantee.</p>
...
<div className="flex flex-wrap">
   ...
   <div className="flex lg:w-3/4 w-full flex-wrap lg:border border-gray-300 rounded-lg  ">
       ...
       <PricingTemplateMobile {...first} finalArr={finalArr} onClick={onClickLocalStorageHandler.bind(null,  parsedPricing?.prices[0]?._id)}/>
       ...
       <PricingTemplateMobile {...second} finalArr={finalArr} onClick={onClickLocalStorageHandler.bind(null,  parsedPricing?.prices[1]?._id)}/>
       ...
       <PricingTemplateMobile {...third} finalArr={finalArr} onClick={onClickLocalStorageHandler.bind(null,  parsedPricing?.prices[2]?._id)}/>
