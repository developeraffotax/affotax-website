...
export default function HowItWorks({HowItWorksSection}) {
    ...
    if(HowItWorksSection === "undefined" || !HowItWorksSection) return;
  ...
  return (
    ...
    <section className="bg-[#23314E] py-12 sm:py-16 lg:py-12 xl:py-12 w-full drop-shadow-lg px-80 max-2xl:px-40 max-xl:px-20  max-lg:px-8  ">
        <div className="mx-auto max-w-7xl px-4  max-lg:px-4">
            <div className="text-center mb-12">
                <h2 className="sm:text-3xl text-2xl font-medium title-font text-gray-100 mb-4">
                    {heading}
                </h2>
                    ...
                    mappedWithIconsArray.map((el) => {
                        return (
                            ...
                            <li key={el._id} className="flex-start group relative flex lg:flex-col">
                                    ...
                                    aria-hidden="true"
                                    />
                                    <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-hover:border-gray-200 group-hover:bg-gray-200">
                                    {el.iconCmp}
                                    </div>
                                    <div className="ml-6 lg:ml-0 lg:mt-10">
                                    <h3 className="text-xl font-bold text-gray-100 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                                    {el.title}
