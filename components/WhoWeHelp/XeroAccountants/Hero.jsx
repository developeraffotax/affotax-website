				...
				<div className="relative  flex  flex-1 flex-col items-start justify-center  ">
					...
					<div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-0 sm:gap-x-4 ">
						<button
							...
							className="flex flex-row items-center text-center justify-center gap-x-2 font-semibold rounded-xl text-white px-8 py-3 bg-orange-500 hover:bg-orange-600  "
						>
							Get a Quote
