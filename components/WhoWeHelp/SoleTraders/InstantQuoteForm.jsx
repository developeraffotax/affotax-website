			...
			<div className="flex flex-col items-center  py-12 px-80 max-2xl:px-40 max-xl:px-10    bg-gradient-to-tr from-orange-300/5 to-orange-900/20">
				...
				<div className="flex w-full justify-center gap-10 ">
					<div className="flex w-full justify-center py-10 items-center ">
						<form className="grid grid-cols-2 gap-10  place-content-start max-lg:grid-cols-1 max-lg:gap-4 text-base">
							<div className="">
							...
							<button type="submit" className="shadow-md shadow-black/30  place-self-center flex flex-row w-[25%] max-lg:w-full hover:bg-[#ec7944] hover:scale-105 active:scale-95 transition-all   col-span-2 max-lg:col-span-1 bg-[#FF7F45] -mt-2 max-lg:mt-2 py-2 rounded-xl text-white font-semibold  justify-center items-center gap-1" ><TbSend /> Submit  </button>
						</form>
					</div>
				</div>
