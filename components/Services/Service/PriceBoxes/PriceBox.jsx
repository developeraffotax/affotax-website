...
const PriceBox = ({ priceTitle, priceContent, price, packageIncludes }) => {
    return (
        <div className="flex flex-row max-lg:flex-col mb-8 gap-8 items-end max-lg:items-center justify-between bg-gray-100 shadow-lg rounded-xl  p-8 w-[70%] max-lg:w-[90%]">
