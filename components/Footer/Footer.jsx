...
export default function Footer() {
  return (
    <footer className="text-gray-600 body-font w-full flex flex-col items-center px-60 max-2xl:px-40 max-xl:px-10 bgImage2">
    ...
    <div>
        <p className='text-sm font-mono '>© Copyright 2023 Affotax - All Rights Reserved</p>
    </div>
