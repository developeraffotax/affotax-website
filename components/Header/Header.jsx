...
import { RxArrowDown, RxCross2, RxHamburgerMenu, RxThickArrowDown } from "react-icons/rx";
...
// console.log(pathRef?.current.classList)
    ...
    <header className=" body-font w-full bg-tertiary font-semibold text-secondary h-auto  px-60 max-2xl:px-40 max-xl:px-10 max-lg:p-0 ">
        ...
        <div className="    mx-auto container  max-lg:hidden">
          ...
          <button className=" text-center  items-center rounded-md bg-primary border-0  px-3 focus:outline-none hover:bg-primary/95 text-base mt-4 md:mt-0 max-lg:py-2 max-md:w-[50%] z-50">
            ...
            <svg style={{marginRight: '5px'}}   width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
            <path fillRule="evenodd" ref={pathRef} className="fill-secondary" clipRule="evenodd" d="M20 4C21.6569 4 23 5.34315 23 7V17C23 18.6569 21.6569 20 20 20H4C2.34315 20 1 18.6569 1 17V7C1 5.34315 2.34315 4 4 4H20ZM19.2529 6H4.74718L11.3804 11.2367C11.7437 11.5236 12.2563 11.5236 12.6197 11.2367L19.2529 6ZM3 7.1688V17C3 17.5523 3.44772 18 4 18H20C20.5523 18 21 17.5523 21 17V7.16882L13.8589 12.8065C12.769 13.667 11.231 13.667 10.1411 12.8065L3 7.1688Z" fill="#ffffff"></path>
            </g>
            </svg>
...
<button className=" text-center  items-center rounded-md bg-primary border-0  px-3 focus:outline-none hover:bg-primary/95 text-base mt-2 py-2 w-[50%]">
  ...
  <div className="flex items-center ">
  <svg style={{marginRight: '5px'}}   width="20px" height="20px" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
  <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
  <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
  <g id="SVGRepo_iconCarrier">
  <path fillRule="evenodd" className="fill-secondary" clipRule="evenodd" d="M20 4C21.6569 4 23 5.34315 23 7V17C23 18.6569 21.6569 20 20 20H4C2.34315 20 1 18.6569 1 17V7C1 5.34315 2.34315 4 4 4H20ZM19.2529 6H4.74718L11.3804 11.2367C11.7437 11.5236 12.2563 11.5236 12.6197 11.2367L19.2529 6ZM3 7.1688V17C3 17.5523 3.44772 18 4 18H20C20.5523 18 21 17.5523 21 17V7.16882L13.8589 12.8065C12.769 13.667 11.231 13.667 10.1411 12.8065L3 7.1688Z" fill="#ffffff"></path>
  </g>
  </svg>
  <span style={{cursor: 'pointer'}} ><a className="hover:text-primary text-secondary" style={{textDecoration: 'none'}} href="mailto:info@affotax.com">info@affotax.com</a></span>
  </div>
