					...
					return (
							...
							<div key={ele.name}>
								...
								<ul
									...
									className="absolute  flex-col text-nowrap transition-all  top-0 left-[230px] py-4 z-0  hidden"
								>
									{ele.submenu.map((el) => {
										return (
											<li
												onClick={(e) => {
													...
													//e.target.parentNode.parentNode.parentNode.classList.add('InnerMenu') 
