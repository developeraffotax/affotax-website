        ...
        <section className=' text-gray-600 w-full bg-slate-50 pt-8 px-80 max-2xl:px-40 max-xl:px-10  max-lg:px-8 bgImage'>
            ...
            <div className=' flex pb-24  flex-row max-lg:flex-col  max-lg:px-4 max-lg:py-8  items-center  justify-between  '>
                <div className='items-start pt-10 max-lg:pt-0 w-[50%] max-w-2xl text-left  flex flex-col  mb-16 md:mb-0  max-lg:w-full max-lg:text-left max-lg:items-center max-lg:pr-0 '>
                    ...
                    <p className='mb-8 leading-relaxed font-semibold text-tertiary/[70] text-xl max-lg:text-lg'>Managing a business in England is a proper royal adventure, but staying on top of your books? Not always a cup of tea. Here at Affotax, we are a team of qualified accountants who specialise in providing accounting and tax filing services. Whether you are a one-man team or a professional business, we can help walk you through your financial challenges, ensuring your journey is as sweet as an English cup of tea 
 </p>
