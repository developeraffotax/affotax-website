...
import { hero, icon1, icon2, icon3, icon4} from "@/assets/Manchester";
...
Manage your accounts from anywhere in the world; our accountants in Manchester are dedicated to your financial prosperity. Put your trust in Affotax; let us handle your accounts and tax filing, and we will help you score a goal.
        ...
        <div className="mx-auto max-w-7xl px-4  max-lg:px-4">
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon1} alt="manchester icon" className="p-2"/>
                </div>
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon2} alt="manchester icon" className="p-2"/>
                </div>
                <div className="ml-6 lg:ml-0 lg:mt-10">
                <h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon3} alt="manchester icon" className="p-2"/>
                </div>
                <div className="ml-6 lg:ml-0 lg:mt-10">
                <h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                Responsive support
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon4} alt="manchester icon" className="p-2"/>
                </div>
                <div className="ml-6 lg:ml-0 lg:mt-10">
                <h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                Value for money
