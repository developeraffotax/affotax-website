...
import { hero, icon1, icon2, icon3, icon4 } from "@/assets/Birmingham";
...
That being said, who’s got time (or frankly, the patience) to manage accounts and tax forms while keeping pace with the Birmingham business hub? Well, our Birmingham accountants provide online accountancy and tax filing services that are as sweet as the chocolates at Cadbury World.
        ...
        <div className="mx-auto max-w-7xl px-4  max-lg:px-4">
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon1} alt="birmingham icon" className="p-2"/>
                </div>
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon2} alt="birmingham icon" className="p-2"/>
                </div>
                <div className="ml-6 lg:ml-0 lg:mt-10">
                <h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon3} alt="birmingham icon" className="p-2"/>
                </div>
                <div className="ml-6 lg:ml-0 lg:mt-10">
                <h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                No more paperwork
            ...
            <li className="flex-start group relative flex lg:flex-col">
                ...
                <Image src={icon4} alt="birmingham icon" className="p-2"/>
                </div>
                <div className="ml-6 lg:ml-0 lg:mt-10">
                <h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                Affordable prices
