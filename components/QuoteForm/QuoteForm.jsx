...
export default function QuoteForm() {
    ...
    const [formState, action] = useFormState(sendQuote, {
        success: false,
        message: ''
    })
	...
	return (
		<>
			<div className="w-full flex flex-col items-center  px-12 py-4 bg-gray-50  " >
				<div>
                ...
                <div className="flex w-full justify-center gap-10 ">
					<div className="flex w-full justify-center py-10 items-center ">
						<form className="grid grid-cols-2 gap-8  place-content-start max-lg:grid-cols-1 max-lg:gap-4 text-base   " action={action}>
							<div className="">
...
// bg-gradient-to-br from-orange-300/5 to-orange-900/20