const serviceData = {
  ...
  faqs: [
    {
      question: "What service do you provide in annual accounts preparation?",
      answer:
    ...
    {
      question: "How do you ensure accuracy in annual statement preparation?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Outsourcing company accounts preparation to us offers several benefits. You can ensure compliance with UK accounting standards and regulations, save time and resources, and avoid the risk of errors and penalties. Our expertise allows you to focus on core business activities while gaining valuable financial insights to drive growth.",
    },
    {
      question: "Do you offer other services customised to UK businesses?",
      answer:
        "Our team follows meticulous procedures to analyse and record financial transactions. We adhere to UK Generally Accepted Accounting Principles (UK GAAP), International Financial Reporting Standards (IFRS), and Companies Act requirements. Thorough reviews and quality checks are conducted throughout the preparation process to ensure the highest level of accuracy.",
    },
    {
...
export const serviceData2 = {
  ...
  prices: [
    ...
    },
    {
      ...
      price: "£249",
      packageIncludes: ["Everything in the above packages", "Tax planning"],
    },
  ],

  benefitsTitle: "Benefits of Our Corporation Tax (CT600) Services ✨🔍",
  benefits: [
    {
      heading: "📊 Easy filing",
      paragraph:
    ...
    {
      heading: "🔒 The best data security",
      paragraph:
    ...
    {
      heading: "📋 Precision in compliance",
      paragraph:
    ...
    {
      heading: "🗣️ Guidance at your fingertips",
      paragraph:
    ...
    {
      heading: "⏱️ Time is money, we save both",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "It's essential to meet the submission deadline to avoid penalties and ensure compliance. The submission deadline is usually within 12 months of the company's accounting period. ",
    },
    {
    ...
    },
    {
      ...
      answer:
        "It requires detailed financial information, such as profits, expenses, deductions, and other relevant financial data. For a correct assessment, accurate and comprehensive reporting is essential.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "When it comes to corporate tax filings, you will undoubtedly need the assistance of a professional accountant or CPA because there are an infinite number of options, questions, and checks and balances that you must carefully review. ",
    },

    {
      question: "How can your services help my business?",
      answer:
        "At Affotax, we offer expert assistance in preparing and filing your  returns with our affordable packages. We ensure accurate calculations, compliance with regulations, and timely submission, allowing you to focus on your core business activities.",
    },

    {
      question: " How do I get started with your services?",
      answer:
        "To get started with our services, choose the package that suits your needs and follow the instructions to purchase. Our experienced staff will walk you through the procedure and make sure your profit levy is taken care of immediately.",
    },
  ],
};
...
const serviceData3 = {
  ...
  benefits: [
    ...
    {
      heading: "🗣️ Personalised assistance",
      paragraph:
    ...
    {
      heading: "⏱️ Optimise your resources",
      paragraph:
  ...
  faqs: [
    {
      ...
      answer:
        "Individuals use a UK tax form to report their income, expenses, and deductions to HM Revenue and Customs (HMRC) for accurate calculations.",
    },
    ...
    },
    {
      ...
      answer:
        "Our starter package offers step-by-step guidance on completing the form, reviewing your financial details, and accurate submission to HMRC. It's perfect for those with straightforward filings. ",
    },
    {
      question: "How can the prime package benefit me?",
      answer:
        "If you have a complex financial situation, the prime package may suit you better. This package includes a thorough review of your financial details, personalised tax planning, and assistance completing the self assessment tax return form to ensure you optimise your position.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Don't worry. You can correct any errors within a specific timeframe. Our packages include guidance on how to make corrections if needed.",
    },
    {
      question:
        "Can I benefit from these packages if I'm self-employed or have multiple sources of income?",
      answer:
        "Our solutions cater to individuals with various financial complexities, offering appropriate levels of support for accuracy and compliance. ",
    },
    {
      question: "How do I get started?",
      answer:
        "Choose a service that suits your needs, follow the instructions to purchase, and our experienced team will guide you through the process, ensuring accurate and timely completion. ",
    },
  ],
};
  ...
  faqs: [
    {
      ...
      answer:
        "You need to complete the PAYE registration form so as to get registered for Paye then send it to HMRC; after that, HMRC will issue you a PAYE reference number which must be included in your payroll records including each employee’s tax details.",
    },

    {
      question: "Do I need to register for paye as a director? ",
      answer:
        "Absolutely, being paid with money that comes from the company requires every director to be registered with PAYE. It involves all kinds of payments like salaries, bonuses, among other things. So as to get an appropriate amount of money as tax from the director's pay, it is important for him/her to register.",
    },
    {
      question: "Is it possible to backdate? ",
      answer:
        "Registering for PAYE in the year when the income is received is necessary. The registration may be penalised or fined if it is delayed. By completing it on time, you can avoid penalties.",
    },
    {
      question: "How long does it take? ",
      answer:
        "It typically takes just a few days and can be done online. Submitting all relevant information accurately and promptly to avoid delays is essential. It's also important to keep records of returns for at least six years. Let Affotax handle your payroll registration easily. ",
    },
    {
      question: "How to cancel it? ",
      answer:
        "You must submit a formal request to the HMRC for cancellation. Your reference number and the cause for the cancellation must be disclosed. After that, the HMRC will handle your request and update the system as needed.",
    },
    {
      question: "Is the process time-sensitive?",
      answer:
        "The timely registration of taxes is one of the most important aspects of tax compliance. Taking advantage of our packages will expedite the process.",
    },
    {
      question: "How do I start with your services?   ",
      answer:
        "First, choose a package that you think could solve your registration issues. After that, follow the purchase instructions and our expert team will reach out to you for assistance with the process. ",
    },
  ],
};
  ...
  prices: [
    {
      ...
      priceContent: "Our basic package covers the preparation and filing.",
      price: "£29",
      packageIncludes: [
  ...
  prices: [
    {
      ...
      price: "£99",
      packageIncludes: ["12-month bookkeeping.", "Full Transactions review"],
    },
    {
      priceTitle: "Filing Express",
      priceContent:
...
export const dataArr = [ serviceData, serviceData2, serviceData3, serviceData4, serviceData5, serviceData6, serviceData7, serviceData8, ];
