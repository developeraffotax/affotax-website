					...
					<div className=" flex pb-24  flex-row max-lg:flex-col  max-lg:px-4 max-lg:py-8  items-center  justify-between  ">
						<div className="items-start pt-10 max-lg:pt-0 w-[50%] max-w-2xl text-left  flex flex-col  mb-16 md:mb-0  max-lg:w-full max-lg:text-left max-lg:items-center max-lg:pr-0 ">
							...
							<p className="mb-8  text-tertiary/[70] text-xl max-lg:text-lg">
								Liverpool offers many opportunities for business
								start-ups and established enterprises to grow.
								It has a growing population and amazing programs
								like the Enterprise Hub Skills, BIPC Liverpool
								and LCR Finance Hub, making it a great place to
								start or develop a business. Our accountants in
								Liverpool can help you achieve these goals.
								<br />
								<br />
								Here at Affotax, we take the burden off your
								shoulders by taking on your accounting and tax
								filing needs. Send us a message or get a quote
								and our Liverpool accountants will respond
								immediately.
							</p>
					...
					<ul className="mx-auto mt-12 grid grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:grid-cols-4">
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700">
									Our chartered accountants boast many years
									of experience in cross-industry operations.
									We update ourselves on all the latest tax
									laws and regulations, so your business is
									always compliant and maximizes its
									deductions.
								</h4>
							</div>
						</li>
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700">
									Ditch time-consuming in-person meetings.
									With our online portal, you can safely
									upload documents, receive immediate views of
									real-time financial reporting, and freely
						...
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700">
									We don't want to just file your tax returns.
									We want to work closely with you to develop
									a solid tax plan that is tailored to you
									specifically, thereby cutting your tax bill
						...
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700 ">
									Unlike traditional accountants, we charge in
									clear fixed-fee packages. This means you'll
				...
				<div className="container px-5 py-12 mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-sm">
							...
							solutions designed to make your operations much
							easier.
						</p>
						<div className="flex mt-6 justify-center">
							<div className="w-16 h-1 rounded-full bg-primary inline-flex" />
					...
					<div className="flex max-md:flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									But with our online portal, everything
									becomes more streamlined and easy from a
									bookkeeping standpoint. You can simply
									upload receipts and invoices, saving you
									time and keeping your financial records
						...
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									We are integrated with commonly preferred
									accounting software that operates through
									the cloud. This feature enables real-time
									access and sharing of data, therefore
									ensuring that you get timely updates and
									have adequate control over your business
									affairs.
								</p>
							</div>
						</div>
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									We provide an automated payroll system that
									will take the burden off your shoulders.
									From salary and deduction calculations to
									timely payment to your employees, it is all
									done here with ease.
								</p>
							</div>
						</div>
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									...
									with our regular financial reports.
									Easy-to-understand dashboards and custom
									reports, keeping you updated and enabling
									data-driven decisions that guide future
									growth.
								</p>
							</div>
						</div>
