...
export const metadata = {
	...
	description:
		...
		metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/accountants-in-bradford`, },
};
					...
					<div className=" flex pb-24  flex-row max-lg:flex-col  max-lg:px-4 max-lg:py-8  items-center  justify-between  ">
						<div className="items-start pt-10 max-lg:pt-0 w-[50%] max-w-2xl text-left  flex flex-col  mb-16 md:mb-0  max-lg:w-full max-lg:text-left max-lg:items-center max-lg:pr-0 ">
							<h1 className=" text-5xl  max-lg:text-4xl mb-4 font-bold  text-tertiary max-lg:text-left">
								Chartered Accountants in Bradford, West
								Yorkshire
							</h1>
							<p className="mb-8  text-tertiary/[70] text-xl max-lg:text-lg">
								Bradford has been ranked as the best place to
								start a business in Britain by the Barclays Bank
								SME Growth Factors Index, and named a top 20
								city for business growth by the Sunday Times in
								2020. However, a sheer dedication is required to
								be successful here, and you cannot do so while
								managing your finances at the same time. This is
								where our accountants Bradford joins the party!
								<br />
								<br />
								Here at Affotax, we are expert accountants in
								Bradford, taking the money worries off your
								plate. So, why not chat with us, and have a
								virtual cup of tea?
							</p>
				...
				<div className="mx-auto max-w-7xl px-4  max-lg:px-4">
					<div className="text-center mb-12">
						<h2 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">
							Why choose our accountants Bradford?
						</h2>
						...
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700">
									Our safe online system allows you to upload
									the necessary documents with ease, avoiding
									the hassle of paper trails.
								</h4>
							</div>
						</li>
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								<h3 className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
									Maximised deductions & credit
								</h3>
								<h4 className="mt-2 text-base text-gray-700">
									Benefit from our vast experience in
									identifying all available tax breaks and
									opportunities for a Bradford-based business.
								</h4>
							</div>
						</li>
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700">
									We make sure that your taxes are filed
									electronically in a way that pays strict
									attention to details, hence minimising
									possibilities of errors and fines.
								</h4>
							</div>
						</li>
						<li className="flex-start group relative flex lg:flex-col">
							...
							<div className="ml-6 lg:ml-0 lg:mt-10">
								...
								<h4 className="mt-2 text-base text-gray-700 ">
									...
									throughout the year. So, get a quote now!
								</h4>
							</div>
						</li>
					</ul>
			...
			<section className="text-gray-600 body-font px-80 max-2xl:px-40 max-xl:px-10  max-lg:px-8">
				<div className="container px-5 py-12 mx-auto">
					<div className="text-center mb-16">
						<h2 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">
							What our Bradford accountants offer
						</h2>
					...
					<div className="flex max-md:flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									No more waiting rooms or scheduling
									conflicts. Manage your finances on your
									terms with our secure online portal. Upload
									documents, track progress, and communicate
									directly with your dedicated accountant –
						...
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									Our team of qualified accountants comprises
									in-depth knowledge of the business landscape
									in Bradford. We remain updated on regional
									tax laws and economic trends to ensure your
									finances are optimised for success in this
									thriving Yorkshire hub.
								</p>
							</div>
						</div>
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									Every business is different, we spend time
									getting to know your requirements as well as
									dreams, creating custom accounting
									strategies that will give you the ability to
									make informed decisions. Leave a message and
									our Bradford accountants will respond
									immediately.
								</p>
							</div>
						</div>
						<div className="p-4 md:w-1/3 flex flex-col text-center items-center">
							...
							<div className="flex-grow">
								...
								<p className="leading-relaxed text-base">
									We handle the complexities of tax filing,
									ensuring your accounts are compliant and
									deadlines are met. Tax season doesn't have
									to be a nightmare; we make it simple with
									effective online tax filing services.
								</p>
							</div>
						</div>
					</div>
					...
					<div className=" mt-20  text-center items-center bg-slate-50 w-full rounded-xl p-12 max-lg:p-6 drop-shadow-md ">
						<h2 className=" title-font text-3xl font-semibold ">
							Ready to talk with expert accountants Bradford?
						</h2>
						<p className="mt-4 text-md ">
							With Affotax, you get a trusted partner dedicated to
							the financial health and growth of your Bradford
							business. Let us navigate the complexities, so you
							can focus on what truly matters – achieving your
