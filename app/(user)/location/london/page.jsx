...
export const metadata = {
	...
	description:
		...
		metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/london`, },
};
		...
		<main className="w-full  flex flex-col items-center justify-between   max-lg:p-0">
            ...
            <div className="container px-5 py-12 mx-auto">
                ...
                <ul className="mx-auto items-center text-center">
                    ...
                    <Link href={'/location/accountants-in-east-london'}>
                    <li className="p-4 bg-white rounded-lg inline-block m-4 text-2xl drop-shadow-md">
                        <div className="flex items-center">
                            ...
                            <span className="title-font font-medium"> Accountants in East London</span>
                        </div>
                    </li></Link>

                    <Link href={'/location/accountants-in-north-london'}>
                    <li className="p-4 bg-white rounded-lg inline-block m-4 text-2xl drop-shadow-md">
                        <div className="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <span className="title-font font-medium">Accountants in North London</span>
                        </div>
                    </li></Link>

                    <Link href={'/location/accountants-in-central-london'}>
                    <li className="p-4 bg-white rounded-lg inline-block m-4 text-2xl drop-shadow-md">
                        <div className="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <span className="title-font font-medium">Accountants in Central London</span>
                        </div>
                    </li></Link>

                    

                    <Link href={'/location/accountants-in-west-london'}>
                    <li className="p-4 bg-white rounded-lg inline-block m-4 text-2xl drop-shadow-md">
                        <div className="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <span className="title-font font-medium">Accountants in West London</span>
                        </div>
                    </li></Link>

                    

                    <Link href={'/location/accountants-in-greenwich'}>
                    <li className="p-4 bg-white rounded-lg inline-block m-4 text-2xl drop-shadow-md">
                        <div className="flex items-center">
                            <svg
                                fill="none"
                            ...
                            <span className="title-font font-medium">Accountants in Greenwich</span>
                        </div>
                    </li></Link>
