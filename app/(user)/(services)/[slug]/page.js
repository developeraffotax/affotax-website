...
export async function generateMetadata({ params }) {
  ...
  switch (params.slug) {
		...
		case "cheap-accountants": return (metadata = { title: "UK Sole Traders Services for Accounting & Tax Filing", keywords: ['cheap accountants'], description: "Welcome to our accountancy website, your go-to destination for cheap accountants who provide top-tier services without breaking the bank. Whether you’re a small business owner, a freelancer, or an individual seeking expert financial management, our team of affordable accountants is here to meet all your accounting needs. ", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
