...
export async function generateMetadata({ params }) {
  ...
  switch (params.slug) {
		case "sole-traders": return (metadata = { title: 'UK Sole Traders Services for Accounting & Tax Filing', description: "UK sole trader business with Affotax's expert accounting and tax filing services. Simplify your finances, maximize profits, and ensure HMRC compliance.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, })
		case "limited-companies": return (metadata = { title: 'Expert Accounting & Tax Services for Limited Companies', description: "Limited Company's finances with Affotax's comprehensive accounting and tax services. Our chartered accountants provide simplified bookkeeping, VAT returns, etc.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
		case "partnerships": return (metadata = { title: 'Affordable Accounting Solutions for UK Partnerships | Affotax', description: "Discover personalised accounting services for partnerships in the UK. Affotax offers tax planning, profit management, cash flow strategies, and more.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
		case "limited-liability-partnerships": return (metadata = { title: 'Accounting & Tax Services for LLPs in the UK - Affotax', description: "Expert accounting and tax solutions for UK LLPs. Affotax ensures boosts profits, and provides ongoing support. Contact us for a free consultation today.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
		case "contractor-accountants": return (metadata = { title: 'Contractor Accounting & Tax Filing Services | Affotax', description: "Effortless accounting and tax filing for contractors. Trust Affotax for IR35 compliance, tax planning, and personalized service. Transparent, fixed-fee pricing.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
		case "small-business-accountants": return (metadata = { title: 'UK Accounting & Tax Services for Small Businesses | Affotax', description: "Empower your small business with Affotax's expert accounting, tax planning, and strategic advice. Maximize deductions and streamline your finances today!", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
		case "xero-accountants": return (metadata = { title: 'Xero Accountants UK - Tax Filing & Business Growth Experts', description: "Unlock Xero's potential with Affotax's expert accountants. Streamline your finances, ease bookkeeping, and get HMRC-compliant tax filing.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
		...
		case "property-accountants": return (metadata = { title: "Property Accountants in UK - Affotax", description: "Property accounting services for landlords & investors. Specializing in tax, bookkeeping, payroll, and more. Find local property accountants near you.", metadataBase: new URL('https://affotax.com'), alternates: { canonical: `/${params.slug}`, }, });
