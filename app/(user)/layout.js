...
export default function RootLayout({ children }) {
	...
	return (
		<>	
			...
			<Link onClick={handleWhatsAppClick} href={"https://wa.me/447537188920"} target="_blank" aria-label="whatsapp-button"> <IoLogoWhatsapp className="fixed size-16 right-5 bottom-28 hover:cursor-pointer hover:scale-110 text-green-500 z-50 " /> </Link>
